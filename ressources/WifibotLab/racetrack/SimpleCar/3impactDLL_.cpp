...
void Init()
{
   ...
   Terrain=iBodyCreate("sphereworld\\sphere1.00.ply");
   TerrainMesh=iBodyMeshCreate("sphereworld\\sphere_.x",Terrain);
   ...
   iBodyLocationSet(CarBody,&D3DXVECTOR3(0.0f,18.0f,0.0f),TRUE);
...
void Run()
{
   ...
   //iBodyAccelerationApply(CarBody,&D3DXVECTOR3(0.0f,0.0f,0.0f));
   //iBodyAccelerationApply(CarWheelFL,&D3DXVECTOR3(0.0f,0.0f,0.0f));
   //iBodyAccelerationApply(CarWheelFR,&D3DXVECTOR3(0.0f,0.0f,0.0f));
   //iBodyAccelerationApply(CarWheelRL,&D3DXVECTOR3(0.0f,0.0f,0.0f));
   //iBodyAccelerationApply(CarWheelRR,&D3DXVECTOR3(0.0f,0.0f,0.0f));
   
   iBodyForceApply(CarBody,&D3DXVECTOR3(0.0f,-200.0f,0.0f),&D3DXVECTOR3(0.0f,0.0f,0.0f));
   //iBodyForceApply(CarWheelFL,&D3DXVECTOR3(0.0f,-1.0f,0.0f),&D3DXVECTOR3(0.0f,1.0f,0.0f));
   //iBodyForceApply(CarWheelFR,&D3DXVECTOR3(0.0f,-1.0f,0.0f),&D3DXVECTOR3(0.0f,1.0f,0.0f));
   //iBodyForceApply(CarWheelRL,&D3DXVECTOR3(0.0f,-1.0f,0.0f),&D3DXVECTOR3(0.0f,1.0f,0.0f));
   //iBodyForceApply(CarWheelRR,&D3DXVECTOR3(0.0f,-1.0f,0.0f),&D3DXVECTOR3(0.0f,1.0f,0.0f));
