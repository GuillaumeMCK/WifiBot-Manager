...
void Init()
{
   ...
   iBodyLocationSet(CarBody,&D3DXVECTOR3(0.0f,25.0f,0.0f),TRUE);
...
void Run()
{
   ...
   //planetcenter = D3DXVECTOR(0.0f,0.0f,0.0f)
   D3DXVECTOR3 bodycenter;
   //bodycenter = iBodyLocationCM(CarBody,&D3DXVECTOR(0.0f,0.0f,0.0f));
   gravity = bodycenter - planetcenter;
